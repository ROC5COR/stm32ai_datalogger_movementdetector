...
#define AI_NETWORK_MODEL_SIGNATURE     "0ff58233a34308239f9b443386c0461d"
...
#define AI_TOOLS_DATE_TIME   "Mon Jul  5 14:54:50 2021"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 768, 50, 1, 1), AI_STRIDE_INIT(4, 4, 3072, 153600, 153600),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv1d_3_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_2_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    conv1d_2_output_array.data = AI_PTR(activations_map[0] + 64);
    conv1d_2_output_array.data_start = AI_PTR(activations_map[0] + 64);
    conv1d_3_output_array.data = AI_PTR(activations_map[0] + 0);
    conv1d_3_output_array.data_start = AI_PTR(activations_map[0] + 0);
    dense_2_output_array.data = AI_PTR(activations_map[0] + 3072);
    dense_2_output_array.data_start = AI_PTR(activations_map[0] + 3072);
    dense_2_nl_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_2_nl_output_array.data_start = AI_PTR(activations_map[0] + 0);
    dense_3_output_array.data = AI_PTR(activations_map[0] + 200);
    dense_3_output_array.data_start = AI_PTR(activations_map[0] + 200);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    conv1d_2_weights_array.data = AI_PTR(weights_map[0] + 0);
    conv1d_2_weights_array.data_start = AI_PTR(weights_map[0] + 0);
    conv1d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_bias_array.data = AI_PTR(weights_map[0] + 576);
    conv1d_2_bias_array.data_start = AI_PTR(weights_map[0] + 576);
    conv1d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_3_weights_array.data = AI_PTR(weights_map[0] + 640);
    conv1d_3_weights_array.data_start = AI_PTR(weights_map[0] + 640);
    conv1d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_3_bias_array.data = AI_PTR(weights_map[0] + 2176);
    conv1d_3_bias_array.data_start = AI_PTR(weights_map[0] + 2176);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights_map[0] + 2208);
    dense_2_weights_array.data_start = AI_PTR(weights_map[0] + 2208);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights_map[0] + 155808);
    dense_2_bias_array.data_start = AI_PTR(weights_map[0] + 155808);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights_map[0] + 156008);
    dense_3_weights_array.data_start = AI_PTR(weights_map[0] + 156008);
    dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_bias_array.data = AI_PTR(weights_map[0] + 156608);
    dense_3_bias_array.data_start = AI_PTR(weights_map[0] + 156608);
    return true;
  }
  return false;
}
