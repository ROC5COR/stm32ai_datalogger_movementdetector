...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "leftright_updown_convolutionnal"
...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 100, 1, 3, 1, NULL), \
}
...
#define AI_NETWORK_IN_1_SIZE        (100 *  3)
